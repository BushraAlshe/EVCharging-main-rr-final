...
def sim_ev_fixed_interval(scenario="L", max_n=1000, step_n=50, start_n=100, reps=40, capacity=1000000, dry_run=False,
    ...
    name = "EV22[%s]__fixed_int_max_n=%d_step_n=%d_start_n=%d_reps=%d_capacity=%d" % (
...
if __name__ == "__main__":
    ...
    sim_ev_fixed_interval(scenario="L", max_n=1000, step_n=50, start_n=100, reps=1, capacity=1000000, dry_run=False)


    # sim_ev(scenario="L", max_n=1000, step_n=50, start_n=100, reps=40, capacity=1000000, dry_run=False,)